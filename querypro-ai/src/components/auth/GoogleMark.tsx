export function GoogleMark() {
  return (
    <svg className="h-[13.5px] w-[13.5px]" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#4285F4"
      ...
      <path
        fill="#EA4335"
        d="M12 4.77c1.77 0 3.35.61 4.6 1.8l3.44-3.44C17.95 1.19 15.23 0 12 0 7.29 0 3.24 2.7 1.26 6.62l4.01 3.11C6.22 6.88 8.87 4.77 12 4.77Z"
      />
    </svg>
  );
}
